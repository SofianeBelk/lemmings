...
tourLemming n (Tombeur di k c) (Etat envi niv r v s) = case (dure (bas c) niv, k <= 0) of
...
tourLemming n (Creuseur di i c) (Etat envi niv r v s) = case (terre (bas c) niv, i > 0) of
...
tourLemming n (Constructeur Gauche i c) (Etat envi niv r v s) = case (vide (gauche c) niv, i > 0) of
...
tourLemming n (Constructeur Droite i c) (Etat envi niv r v s) = case (vide (droite c) niv, i > 0) of
